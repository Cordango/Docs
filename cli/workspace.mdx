...
`.cordango/` with the leading dot is build output. `cordango build` regenerates it, and it doesn't
get committed. `cordango new` writes a `.gitignore` that already excludes it.
