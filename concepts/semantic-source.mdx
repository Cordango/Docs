...
The same entity three ways: what you write, what it compiles to, and what the `dotnet-vue`
generator turns that into.
...
```json App Definition
{
  ...
  "fields": [
    ...
    },
    {
      ...
      "required": true,
      "options": [
        { "value": "engineering", "label": "Engineering", "color": "#0f766e" },
...
public sealed class Team : IRecord, IHasTrackingFields
{
    ...
    // record_state follow. The runtime fills them in.
}
```
</CodeGroup>

The C# tab is trimmed: the real file carries a doc comment on every property, and the tracking
fields written out in full.
